...
set "PY_SCRIPT=%SCRIPT_DIR%tools\create_blend.py"
...
echo Set BLENDER_PATH or create blender_path.txt beside this script.
echo Example blender_path.txt:
echo   C:\Program Files\Blender Foundation\Blender 4.3\blender.exe
exit /b 1

:missing_script
echo Could not find tools\create_blend.py beside this script or in the current directory.
exit /b 1
